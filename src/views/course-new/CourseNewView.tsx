...
function CourseNewAccessDenied() {
  return (
...
export async function CourseNewView() {
  ...
  return (
    <RoleGuard role={role} allowedRoles={[AUTH_ROLES.INSTRUCTOR]} fallback={<CourseNewAccessDenied />}>
      <CourseNewFormSection />
    </RoleGuard>
  );
}
